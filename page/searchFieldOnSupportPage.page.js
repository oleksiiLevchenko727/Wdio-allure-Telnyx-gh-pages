...
class searchOnSupportCenterPage {

        get searchField() {return $('[placeholder="Search for articles..."]')}
        get firstResult() {return $$('.collection-link')}
        get assertionText() {return $('.mb-1')}
        ...
        get totalAmount() {return $('div[role="rowheader"][class="_1x41w3p7"]')}
             ...
             async setText () {
               await this.searchField.setValue('HD Voice - Number Feature');
               await browser.keys('Enter');
             }
             async clickOnFirstResult() {
               await this.firstResult[0].waitForDisplayed();
               await this.firstResult[0].click();
             }  

             async getAssertionText() {   
               await this.assertionText.getText();
             }
...
export default new searchOnSupportCenterPage()